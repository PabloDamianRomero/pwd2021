...
// Primero verifico que, si el usuario a borrar es Admin, haya otro Admin para evitar insconsistencia en la BD.
...
if(count($arregloUs)>0 && $arregloUs[0]->getObjRol()->getIdRol()==1){
    ...
    //Chequeo tambien si el usuario a borrarse es de la sesion activa. De ser asi, se debera cerrar la sesion luego del cambio.
...
// De ser posible, se continua con el cambio de estado.
if ($procede){
    ...
    if ($resp){
        ...
        echo '<div class="alert alert-success d-flex align-items-center" role="alert">
                ...
                <div>
                    El estado del usuario fue cambiado con exito.
                </div>
            </div>';
    }else{
    ...
    echo '<div class="alert alert-danger d-flex align-items-center" role="alert">
            <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
            <div>
                Error en el cambio de estado. Debe haber mas de un Administrador para realizar esta operacion.
            </div>
        </div>';
}
